...
const testProcessRewardsAndPenalties = @import("./process_epoch_fn.zig").getTestProcessFn(state_transition.processRewardsAndPenalties, false, false, false).testProcessEpochFn;
