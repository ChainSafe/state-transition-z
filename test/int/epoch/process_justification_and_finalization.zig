...
const processJustificationAndFinalization = state_transition.processJustificationAndFinalization;
...
test "processJustificationAndFinalization - sanity" {
    ...
    inline for (validator_count_arr) |validator_count| {
        ...
        try processJustificationAndFinalization(test_state.cached_state, &epoch_transition_cache);
    }
}
