...
pub fn increaseBalance(state: *const BeaconStateAllForks, index: ValidatorIndex, delta: u64) void {
...
pub fn decreaseBalance(state: *const BeaconStateAllForks, index: ValidatorIndex, delta: u64) void {
